...
overview_url = "https://www.onedoc.ch/de/klinik"  # Updated URL
...
def save_to_csv(data, filename="clinics_all.csv"):
...
def load_already_scraped_practices():
    ...
    scraped_urls = set()
    if os.path.exists('clinics_progress.csv'):
        with open('clinics_progress.csv', 'r', encoding='utf-8') as f:
...
def main():
    ...
    save_to_csv(all_practices, "all_clinics.csv")
